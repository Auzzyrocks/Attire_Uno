            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    ...
                    case 4: // ForecastPage.xaml line 32
                        ...
                        break;
                    case 5: // ForecastPage.xaml line 50
                        this.obj5 = global::WinRT.CastExtensions.As<global::Microsoft.UI.Xaml.Controls.GridView>(target);
                        break;
            ...
            private void UpdateTwoWay_4_Text()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        ...
                        {
                            this.dataRoot.ViewModel.CitySelected = this.obj4.Text;
                        }
                    }
                }
            }
